...
import shutil
import traceback
from pipeline.originals.colab141 import main as colab141_main
...
def run(ai_case_id: str, input_file_path: str):
    ...
    run_dir = tempfile.mkdtemp(prefix="cashai03_141_", dir="/tmp")
    ...
    try:
        ...
        if not KEEP_WORK_DIR:
            try:
                ...
                print("runner141 cleanup error:", cleanup_error)
